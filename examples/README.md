...
| [railway-vms](railway-vms/) | Two free Railway VMs from `ssh railway.new`, no account: the same agents and human gate as e2b-sandboxes, over plain SSH. `--fake` runs it with two local folders. |
